...
public function actionNoticia($slug)
    {
        ...
        //$noticia = \app\models\Post::find("seo_slug = :slug", [":slug" => $slug])->one();
        //$noticiaC = \app\models\Post::find()->where(['seo_slug' => $slug])->one();
        $noticia = \app\models\Post::getAllLeft($slug);
...
//
//        $noticia = \common\models\Noticia::getAllLeft($slug); // ---> CONSULTA COMPLETA
//       
//
